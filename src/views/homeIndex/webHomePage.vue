    ...
    <div class="flex-col story_list">
      <div class="flex-row">
        ...
        <div :class="`flex-col story right-story ${sectionActive === 2 && 'right-active'}`" @click="(e) => setSectionActive(e, 2)">
          ...
          <div :class="`justify-between story_detail ${sectionActive === 2 && 'story_detail_active'}`">
            <div class="flex-col desc">
              <span>
                三个月前，博士通过观测发现，一颗在元星系中从未见过的行星，进入了元星球的环绕轨道中，并且这颗行星的质量和引力似乎出奇的大，不明行星周围环绕着越来越多的卫星，甚至其他行星的环绕轨迹，都开始受到了这颗不明高质量行星的影响，博士似乎感觉到了什么。
              </span>
              <span>
                非常巧合的是，这颗不明行星似乎也被一股神秘的磁场包围，而这个磁场的特征，居然和航天局提供的南半球笼罩的磁场特征，出奇的相似，此刻，博士的内心变得更加不安，通过严密的计算和分析，博士团队有了一个较为清晰的答案，不明行星的的构成与南半球大概率为，同一种物质，一种可以散发可见电磁波的高密度超重物质，这种物质也是元星球从北到南重力逐渐增大的根本原因。
              </span>
              <span>
      ...
      <div :class="`flex-col story_3 ${sectionActive === 3 && 'active'}`" @click="(e) => setSectionActive(e, 3)">
        ...
        <div :class="`justify-between story_detail ${sectionActive === 3 && 'story_detail_active'}`">
          <div class="flex-col desc">
            <span>
              元计划正式启动后由博士领导各领域顶尖科学家团队，以及护卫军队随行为不引起民众恐慌动乱，于夜色中秘密出发南部磁场边界这一次打开红色电磁力场与以往不同，博士团队利用从异常行星采集的频率波段对红磁场进行点对点式穿透果然不负众望，经过几天的尝试连接南北半球的通道终于被打开。
            </span>
            <span>
              北部族对南半球认知非常有限他们并不清楚通道的另一边是否有危险生物军队上校提出清除障碍行动，博士表示反对第一次接触印象尤为重要，军队的行动容易被视为敌意行为。博士认为科研队派出先锋小队作为外交使者经过一番争论，上校妥协。但声明遇到威胁安全情况，军队命令与行动享优先权。
            </span>
            <span>
              与此同时，通灵者大会召集各族长以及各族优秀战士汇聚一堂，告知族人们北部元类即将打开通道进入他们的领地。一直生存在肉弱强食南部世界，处于食物链顶端的各族长与战士表示宣示主权，驱逐外来者通灵者之首，巫祭认为事情没有那么简单，他们通过灵视看到过北部族科技力量，能轻易之间毁灭一个小部落，如今他们的武器装备远不及北部元类。尚不清楚对方来意不可轻举妄动。经讨论南部元类暂时遵巫祭所言，一边派出战士监督北部元类动作，一边集合战士守卫家园。
            </span>
            <span>
              另外一边，博士团队派出的无人机探测取样分析后，数据表示北部元类若在没有防护措施下进入南半球区域，有毒的空气将会在一分钟内使元类休克，五分钟后死亡100倍的重力之下，进入南半球的元类都需穿戴特制的外附铠甲，以消除重力差异影响。博士团队与护卫军进入南半球部族亲眼了解到这里的荒凉，飞沙走石不见绿。
            </span>
            <span>
              此行目的是寻找散发可见电磁波的高密度超重物质，这种物质被博士们团队命为“以太”，随着他们继续前进，以太信号探测器显示信号越清晰。追寻信号的第一天，他们见到了各类体型巨大的陆地生物。
            </span>
            <span>
              当天傍晚，博士团队突然遭受星犀牛群的攻击，博士判断是他们误闯了星犀牛领地，面对发怒的星犀牛群，士兵们本能反应拿起手中的激光枪反击防卫。意外地是小功率激光枪对星犀牛并没有作用大功率激光枪，也并不能一击必杀星犀牛一时之间。团队被冲散，不少士兵更是被星犀牛撞破防护面罩，中毒而亡。
            </span>
            <span>
              上校的侦察兵发现，这星犀牛群背后，隐藏着元皮肤外露于空气而行动敏捷，明显不是北部族同伴。绝对是南部蛮夷元类设置如此卑鄙的陷阱，因被偷袭护卫军损失了几十名手下，上校怒不可遏不顾博士的阻拦，上校发誓要报仇为死去的战友讨回公道。上校取得最高指挥权召集后援重火力部队，大批空中战斗侦察机从通道涌入。
            </span>
            <span>未完待续 更多内容关注公众号获取</span>
          </div>
          <div class="flex-col items-center scan_code_wrapper">
